...
Droid::Droid(const Droid& other) : _id(other._id), _energy(other._energy), _attack(other._attack), _toughness(other._toughness), _status(new std::string(*other._status)) {
